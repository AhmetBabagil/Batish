...
public class SpaceInvadersInvaders : MonoBehaviour
{
    [Header("Invaders")]
    public SpaceInvadersInvader[] prefabs = new SpaceInvadersInvader[5];
    public AnimationCurve speed = new AnimationCurve();
    public Vector3 direction { get; private set; } = Vector3.right;
    public Vector3 initialPosition { get; private set; }
    public System.Action<SpaceInvadersInvader> killed;
    ...
    [Header("Missiles")]
    public SpaceInvadersProjectile missilePrefab;
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            ...
            {int randomnumber=(int)Random.Range(0, 24);
                // Create an invader and parent it to this transform
                SpaceInvadersInvader invader = Instantiate(prefabs[randomnumber], transform);
