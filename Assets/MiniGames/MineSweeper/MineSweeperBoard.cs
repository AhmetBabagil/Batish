...
public class MineSweeperBoard : MonoBehaviour
{
    ...
    public void Draw(MineSweeperCellGrid grid)
    {
    ...
    private TileBase GetTile(MineSweeperCell cell)
    {
        if (cell.revealed)
        {
    ...
    private TileBase GetRevealedTile(MineSweeperCell cell)
    {
        switch (cell.type)
        {
            case MineSweeperCell.Type.Empty: return tileEmpty;
            case MineSweeperCell.Type.Mine: return cell.exploded ? tileExploded : tileMine;
            case MineSweeperCell.Type.Number: return GetNumberTile(cell);
            default: return null;
        }
    }

    private TileBase GetNumberTile(MineSweeperCell cell)
    {
        switch (cell.number)
        {
