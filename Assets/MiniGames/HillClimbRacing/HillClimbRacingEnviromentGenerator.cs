...
[ExecuteInEditMode]
public class HillClimbRacingEnviromentGenerator : MonoBehaviour
{
    [SerializeField] private SpriteShapeController _spriteShapeController;

    [SerializeField, Range(3f, 500f)] private int _levelLength = 50;
    ...
    private void Start()
    {
        _noiseStep = Random.Range(0.4f, 0.6f);
    }
}